...
class ContainerApiGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'mustang:generate:container:api';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Create a Container for Mustang from scratch (API Part)';
    /**
    ...
    public function getUserInputs(): ?array
    {
        ...
        $this->call('mustang:generate:readme', [
            '--section' => $sectionName,
        ...
        $this->call('mustang:generate:configuration', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('mustang:generate:provider', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('mustang:generate:model', [
            '--section' => $sectionName,
            '--container' => $containerName,
            '--file' => $model,
            '--repository' => true,
        ...
        $this->call('mustang:generate:migration', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('mustang:generate:transformer', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('mustang:generate:factory', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        foreach ($routes as $route) {
            $this->call('mustang:generate:request', [
                '--section' => $sectionName,
                '--container' => $containerName,
                '--file' => $route['request'],
                '--ui' => $ui,
            ...
            $this->call('mustang:generate:action', [
                '--section' => $sectionName,
                '--container' => $containerName,
                '--file' => $route['action'],
                '--ui' => $ui,
            ...
            $this->call('mustang:generate:task', [
                '--section' => $sectionName,
                '--container' => $containerName,
                '--file' => $route['task'],
                '--model' => $model,
            ...
            if ($generateEvents) {
                $this->call('mustang:generate:event', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['event'],
                    '--model' => $model,
            ...
            if ($generateTests) {
                $this->call('mustang:generate:test:unit', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['unittest'],
                    '--model' => $model,
                ...
                $this->call('mustang:generate:test:functional', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
            ...
            if ($controllertype === 'sac') {
                $this->call('mustang:generate:route', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['name'],
                    '--ui' => $ui,
                ...
                $this->call('mustang:generate:controller', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
