...
class ContainerGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'mustang:generate:container';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Create a Container for Mustang from scratch';
    /**
    ...
    public function getUserInputs(): ?array
    {
        ...
        if ($ui === 'api' || $ui === 'both') {
            $this->call('mustang:generate:container:api', [
                '--section' => $sectionName,
        ...
        if ($ui === 'web' || $ui === 'both') {
            $this->call('mustang:generate:container:web', [
                '--section' => $sectionName,
                '--container' => $containerName,
                '--file' => 'composer',
                '--maincalled' => true,
