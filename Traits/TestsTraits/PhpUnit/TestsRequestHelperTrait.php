...
namespace Mustang\Core\Traits\TestsTraits\PhpUnit;

use Mustang\Core\Exceptions\MissingTestEndpointException;
use Mustang\Core\Exceptions\UndefinedMethodException;
use Mustang\Core\Exceptions\WrongEndpointFormatException;
...
trait TestsRequestHelperTrait
{
    ...
    private function buildUrlForUri($uri): string
    {
        ...
        return Config::get('mustang.api.url') . $uri;
    }
    ...
    {
        return (Config::get('mustang.hash-id') && !$skipEncoding) ? Hashids::encode($id) : $id;
    }
