...
use Mustang\Core\Abstracts\Models\UserModel;
...
trait TestsAuthHelperTrait
{
    ...
    public function getTestingUser(?array $userDetails = null, ?array $access = null, bool $createUserAsAdmin = false): UserModel
    {
        ...
        $this->userClass = $this->userclass ?? Config::get('mustang.tests.user-class');
        $this->userAdminState = Config::get('mustang.tests.user-admin-state');
