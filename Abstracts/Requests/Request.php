...
namespace Mustang\Core\Abstracts\Requests;

use Mustang\Core\Abstracts\Models\UserModel as User;
use Mustang\Core\Exceptions\IncorrectIdException;
use Mustang\Core\Traits\HashIdTrait;
use Mustang\Core\Traits\SanitizerTrait;
use Mustang\Core\Traits\StateKeeperTrait;
...
abstract class Request extends LaravelRequest
{
    ...
    public function hasAccess(User $user = null): bool
    {
        ...
        if ($user) {
            $autoAccessRoles = Config::get('mustang.requests.allow-roles-to-access-all-routes');
